...
//evaluation functions - returns results pitch class evaluation percentages for training data 
// it has an option to include test data

async function evaluate(testData) {
  let results = {};
